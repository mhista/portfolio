  ...
  static List<Project> getMockProjects() {
    return [
      Project(
        ...
        imageUrl: 'images/project/turu/turu (1).png',
        year: '2026',
        order: 1,
        featured: true,
        ...
        images: [
          'images/project/turu/turu (1).png',
          'images/project/turu/turu (2).png',
          'images/project/turu/turu (3).png',
          'images/project/turu/turu (4).png',
        ],
        results: [
      ...
      Project(
        ...
        imageUrl: 'images/project/psky/psky (1).png',
        year: '2025',
        order: 2,
        featured: true,
        technologies: [
        ...
        images: [
          'images/project/psky/psky (1).png',
          'images/project/psky/psky (7).png',
          'images/project/psky/psky (8).png',
          'images/project/psky/psky (2).png',
          'images/project/psky/psky (3).png',
          'images/project/psky/psky (4).png',
          'images/project/psky/psky (5).png',
          'images/project/psky/psky (6).png',
        ],
        results: [
      ...
      Project(
        ...
        imageUrl: 'images/project/furn/furn (4).png',
        year: '2024',
        order: 3,
        featured: true,
        technologies: ['HTML', 'CSS', 'E-commerce', 'Responsive Design', 'Modern UI/UX', 'Content Management'],
        images: [
          'images/project/furn/furn (4).png',
          'images/project/furn/furn (2).png',
          'images/project/furn/furn (3).png',
          'images/project/furn/furn (1).png',
          'images/project/furn/furn (5).png',
        ],
        results: [
      ...
      Project(
        ...
        imageUrl: 'images/project/asami/asami (1).png',
        year: '2025',
        order: 4,
        featured: true,
        technologies: [
        ...
        projectUrl: 'https://asami.ng',
        images: [
          'images/project/asami/asami (1).png',
          'images/project/asami/asami (2).png',
          'images/project/asami/asami (3).png',
          'images/project/asami/asami (4).png',
          'images/project/asami/asami (5).png',
          'images/project/asami/asami (6).png',
        ],
        results: [
      ...
      Project(
        ...
        imageUrl: 'images/project/medici/medici (3).jpg',
        year: '2024',
        order: 5,
        featured: true,
        isMobile: true,
        ...
        images: [
          'images/project/medici/medici (8).jpg',
          'images/project/medici/medici (3).jpg',
          'images/project/medici/medici (1).jpg',
          'images/project/medici/medici (2).jpg',
          'images/project/medici/medici (4).jpg',
          'images/project/medici/medici (5).jpg',
          'images/project/medici/medici (6).jpg',
          'images/project/medici/medici (7).jpg',
          'images/project/medici/medici (8).jpg',
          'images/project/medici/medici (9).jpg',
          'images/project/medici/medici (10).jpg',
          'images/project/medici/medici (11).jpg',
          'images/project/medici/medici (12).jpg',
        ],
        results: [
      ...
      Project(
        ...
        imageUrl: 'images/project/picki/picki (4).jpg',
        year: '2024',
        order: 6,
        featured: true,
        isMobile: true,
        ...
        images: [
          'images/project/picki/picki (1).jpg',
          'images/project/picki/picki (2).jpg',
          'images/project/picki/picki (3).jpg',
          'images/project/picki/picki (4).jpg',
          'images/project/picki/picki (5).jpg',
          'images/project/picki/picki (6).jpg',
          'images/project/picki/picki (7).jpg',
          'images/project/picki/picki (8).jpg',
          'images/project/picki/picki (9).jpg',
          'images/project/picki/picki (10).jpg',
          'images/project/picki/picki.jpg',
        ],
        results: [
